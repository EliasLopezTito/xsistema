    ...
    if (kendo.ui.ColumnMenu) {
      kendo.ui.ColumnMenu.prototype.options.messages =
        $.extend(true, kendo.ui.ColumnMenu.prototype.options.messages, {
          ...
          "columns": "Columnas",
          "done": "Hecho",
          "settings": "ConfiguraciÃ³n de columnas",
          "lock": "Bloquear",
          "unlock": "Desbloquear"
        });
    }
    ...
    if (kendo.ui.Editor) {
      kendo.ui.Editor.prototype.options.messages =
        $.extend(true, kendo.ui.Editor.prototype.options.messages, {
          ...
          "indent": "Poner sangrÃ­a",
          "outdent": "Quitar sangrÃ­a",
          ...
          "fontSize": "Seleccionar tamaÃ±o de fuente",
          "fontSizeInherit": "(tamaÃ±o heredado)",
          "formatBlock": "Formato",
          "formatting": "Formato",
          "foreColor": "Color",
          "backColor": "Color de fondo",
          "style": "Estilos",
          "emptyFolder": "Carpeta vacÃ­a",
          "uploadFile": "Subir",
          "orderBy": "Ordenados por:",
          "orderBySize": "TamaÃ±o",
          "orderByName": "Nombre",
          "invalidFileType": "El fichero seleccionado \"{0}\" no es vÃ¡lido. Los tipos de ficheros soportados son {1}.",
          "deleteFile": 'Â¿EstÃ¡ seguro que quiere eliminar "{0}"?',
          "overwriteFile": 'Un fichero con el nombre "{0}" ya existe en el directorio actual. Â¿Desea reemplazarlo?',
          "directoryNotFound": "Un directorio con este nombre no fue encontrado.",
          "imageWebAddress": "DirecciÃ³n Web",
          "imageAltText": "Texto alternativo",
          "imageWidth": "Ancho (px)",
          "imageHeight": "Alto (px)",
          "fileWebAddress": "DirecciÃ³n Web",
          "fileTitle": "TÃ­tulo",
          "linkWebAddress": "DirecciÃ³n Web",
          "linkText": "Texto",
          "linkToolTip": "ToolTip",
    ...
    if (kendo.ui.FileBrowser) {
      kendo.ui.FileBrowser.prototype.options.messages =
        $.extend(true, kendo.ui.FileBrowser.prototype.options.messages, {
          ...
          "invalidFileType": "El fichero seleccionado \"{0}\" no es vÃ¡lido. Los tipos de ficheros soportados son {1}.",
          "overwriteFile": "Un fichero con el nombre \"{0}\" ya existe en el directorio actual. Â¿Desea reemplazarlo?",
          "dropFilesHere": "arrastre un fichero aquÃ­ para subir",
          "search": "Buscar"
        });
    }
      ...
      kendo.ui.Grid.prototype.options.messages =
        $.extend(true, kendo.ui.Grid.prototype.options.messages, {
          ...
          "editable": {
            ...
            "confirmation": "Â¿Confirma la eliminaciÃ³n de este registro?",
    ...
    if (kendo.ui.Groupable) {
      kendo.ui.Groupable.prototype.options.messages =
        $.extend(true, kendo.ui.Groupable.prototype.options.messages, {
          "empty": "Arrastre el tÃ­tulo de una columna y suÃ©ltelo aquÃ­ para agrupar por ese criterio"
        });
    }
    ...
    if (kendo.ui.PivotGrid) {
      kendo.ui.PivotGrid.prototype.options.messages =
        $.extend(true, kendo.ui.PivotGrid.prototype.options.messages, {
          "measureFields": "Colocar campos de datos aquÃ­",
          "columnFields": "Colocar campos de columna aquÃ­",
          "rowFields": "Colocar campos de filas aquÃ­"
        });
    }
    ...
    if (kendo.ui.RecurrenceEditor) {
      kendo.ui.RecurrenceEditor.prototype.options.messages =
        $.extend(true, kendo.ui.RecurrenceEditor.prototype.options.messages, {
          ...
          "weekdays": {
            "day": "dÃ­a",
            "weekday": "dÃ­a de semana",
            "weekend": "dÃ­a de fin de semana"
          }
        });
    }
    ...
    if (kendo.ui.Scheduler) {
      kendo.ui.Scheduler.prototype.options.messages =
        $.extend(true, kendo.ui.Scheduler.prototype.options.messages, {
          ...
          "event": "Evento",
          "time": "Hora",
          "showFullDay": "Mostrar dÃ­a completo",
          ...
          "editable": {
            "confirmation": "Â¿EstÃ¡ seguro que quiere eliminar este evento?"
          },
          "views": {
            "day": "DÃ­a",
            "week": "Semana",
          ...
          "recurrenceMessages": {
            ...
            "deleteRecurring": "Â¿Quiere eliminar esta ocurrencia del evento o la serie completa?",
            "editRecurring": "Â¿Quiere editar esta ocurrencia del evento o la serie completa?"
          },
          "editor": {
            "title": "TÃ­tulo",
            "start": "Inicio",
            "end": "Fin",
            "allDayEvent": "Todo el dÃ­a",
      ...
      kendo.spreadsheet.messages.dialogs =
        $.extend(true, kendo.spreadsheet.messages.dialogs, {
          ...
          "validationDialog": {
            ...
            "hintMessage": "Por favor, ingrese un {0} valor {1} vÃ¡lido.",
            "hintTitle": "ValidaciÃ³n {0}",
            "criteria": {
              "any": "Cualquer valor",
              "number": "NÃºmero",
              "text": "Texto",
            ...
            "comparerMessages": {
              ...
              "custom": "que satisface la fÃ³rmula: {0}"
            },
            "labels": {
              "criteria": "Criterios",
              "comparer": "Comparer",
          ...
          "useKeyboardDialog": {
            ...
            "errorMessage": "Estas acciones no se pueden invocar a travÃ©s del menÃº. Utilice los mÃ©todos abreviados de teclado en su lugar:",
            "labels": {
              "forCopy": "para copiar",
              "forCut": "para cortar",
              "forPaste": "para pegar"
          ...
          "unsupportedSelectionDialog": {
            "errorMessage": "Esa acciÃ³n no se puede realizar en la selecciÃ³n mÃºltiple."
          }
        });
    }
    ...
    if (kendo.spreadsheet && kendo.spreadsheet.messages.filterMenu) {
      kendo.spreadsheet.messages.filterMenu =
        $.extend(true, kendo.spreadsheet.messages.filterMenu, {
          ...
          "apply": "Aplicar",
          "search": "Buscar",
          "addToCurrent": "AÃ±adir a la selecciÃ³n actual",
          "clear": "Limpar",
    ...
    if (kendo.spreadsheet && kendo.spreadsheet.messages.toolbar) {
      kendo.spreadsheet.messages.toolbar =
        $.extend(true, kendo.spreadsheet.messages.toolbar, {
          "addColumnLeft": "AÃ±adir columna izquierda",
          "addColumnRight": "AÃ±adir columna derecha",
    ...
    if (kendo.spreadsheet && kendo.spreadsheet.messages.view) {
      kendo.spreadsheet.messages.view =
        $.extend(true, kendo.spreadsheet.messages.view, {
          "errors": {
            "shiftingNonblankCells": "No se pueden insertar las celdas debido a la posibilidad de pÃ©rdida de datos. Seleccione otra ubicaciÃ³n de inserciÃ³n o borre los datos del final de su hoja de trabajo.",
            "filterRangeContainingMerges": "No se puede crear un filtro dentro de un intervalo que contenga fusiones",
            "validationError": "El valor que introdujo viola las reglas de validaciÃ³n establecidas en la celda."
          },
          "tabs": {
            "home": "Casa",
            "insert": "Insertar",
      ...
      kendo.ui.TreeList.prototype.options.messages =
        $.extend(true, kendo.ui.TreeList.prototype.options.messages, {
          ...
          "commands": {
            ...
            "createchild": "AÃ±adir registro hijo",
            "destroy": "Borrar",
    ...
    if (kendo.ui.Upload) {
      kendo.ui.Upload.prototype.options.localization =
        $.extend(true, kendo.ui.Upload.prototype.options.localization, {
          ...
          "dropFilesHere": "Arrastre los archivos aquÃ­ para subirlos",
    ...
    if (kendo.ui.Validator) {
      kendo.ui.Validator.prototype.options.messages =
        $.extend(true, kendo.ui.Validator.prototype.options.messages, {
          ...
          "pattern": "{0} no es vÃ¡lido",
          "min": "{0} debe ser mayor o igual a {1}",
          "max": "{0} debe ser menor o igual a {1}",
          "step": "{0} no es vÃ¡lido",
          "email": "{0} no es un correo electrÃ³nico vÃ¡lido",
          "url": "{0} no es una URL vÃ¡lida",
          "date": "{0} no es una fecha vÃ¡lida",
