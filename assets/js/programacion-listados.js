                    ...
                    if(datos.programacion != "vacio"){
                        ...
                        for(i=0;i<programaciones.length;i++){
                            ...
                            var tr = "<tr>" + 
                                    ...
                                    "<button class='btn boton-tabla boton-verde icon-file-excel' type=\"button\" onclick=\"imprimirListadoIndividual(this,4);\" title=\"Alumnos matriculados - Reporte Excel\"></button>"+
                                    "<button class='btn boton-tabla boton-rojo icon-file-excel' type=\"button\" onclick=\"imprimirListadoIndividual(this,5);\" title=\"Alumnos no matriculados - Reporte Excel\"></button>"+
                                    "</td>"                                      
                                    "</tr>";
