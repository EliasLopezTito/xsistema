            ...
            if (datos.data !== null) {
                if (datos.data.success === true) {
                    ...
                    setTimeout(() => {
                        ...
                        sexo = $("#sexo").val() == 'F' ? 'FEMENINO' : 'MASCULINO'
    
                        if($("#idSexo").val().trim() != sexo){
                            $("#idSexo").css("border", "1px solid blue");
                        }else{
                            $("#idSexo").css("border", "1px solid green");
                        }
    
                        if($("#idFechaNac").val().trim() != $("#fechaNac").val().trim()){
                            $("#idFechaNac").css("border", "1px solid blue");
                        }else{
                            $("#idFechaNac").css("border", "1px solid green");
                        }
                    }, 1000);
        ...
        success: function (data) {
            ...
            if (datos.data !== null) {
                if (datos.data.success === true) {
                    ...
                    $(".seccion_nacimiento").hide()

                } else {
                    $("#idDni").val(null); 
                    $("#idDni").css("border", "1px solid red");
                    $("#idNombres").val(null);
                    $("#idNombres").css("border", "1px solid red");
                    $("#idApellidos").val(null);
                    $("#idApellidos").css("border", "1px solid red");
                    $("#sexo").val("---")
...
$("#fechaNac").change(function(){
    ...
    var edad = today.getFullYear() - dob.getFullYear();
