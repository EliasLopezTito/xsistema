...
$("#alumnoInsert").change(function (event) {
    ...
    // $.ajax({
    //     url: path + "notas/jsonActasNominasPremiun",
    //     type: "POST",
    //     data: {
...
function editarAlumno(id, periodo) {
    ...
    $.post(path + "Notas/jsonActasNominasPremiun", { id: id, periodo: periodo, opcion: 'verEditar' })
        .done(function (r) {
...
function insertarAlumno(semestre, codAlumno, tipoActa, codEspe, ciclo, turno) {
    ...
    Notiflix.Confirm.Show(
        ...
        function () {
            ...
            $.post(path + "Notas/jsonActasNominasPremiun", { semestre: semestre, codAlumno: codAlumno, tipoActa: tipoActa, codEspe: codEspe, ciclo: ciclo, turno: turno, opcion: 'duplicarAlumno' })
                .done(function (r) {
                    response = JSON.parse(r)
                    if (response.respuesta === 'success') {
...
function eliminarAlumno(idAJ, codAlumno) {
    ...
    Notiflix.Confirm.Show(
        ...
        'No',
        function () {
            $.post(path + "Notas/jsonActasNominasPremiun", { idAJ: idAJ, semestre: $('#periodo').val() , opcion: 'eliminarAlumno' })
                .done(function (r) {
                    response = JSON.parse(r)
                    if (response.respuesta === 'success') {
