...
function exportarResultados(btn){
    var idEncuesta = $(btn).parent().parent().find("td").eq(0).html();
    var anoProg = $(btn).parent().parent().find("td").eq(4).html();    
    var mesProg = $(btn).parent().parent().find("td").eq(5).html();    
        
    var target = path + "encuesta/reporteCalificacion";
    $("#frmReporteCalificacion").attr("action",target);
    $("#frmReporteCalificacion").attr("target","_blank");
    $("#idEncuesta").val(idEncuesta);
    $("#anoProg").val(anoProg);
    $("#mesProg").val(mesProg);
    
    $("#frmReporteCalificacion").submit();
}
