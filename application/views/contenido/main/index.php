                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="d-flex">
                            <select name="campaign-type" data-control="select2" data-hide-search="true"
                                ...
                                data-select2-id="select2-data-7-6vgv" tabindex="-1" aria-hidden="true"
                                data-kt-initialized="1">
                                <option value="Twitter" selected="selected" data-select2-id="select2-data-9-i40c">Select
                                    Campaign</option>
                                ...
                                data-select2-id="select2-data-8-r3c2" style="width: 100%;"><span class="selection"><span
                                        class="select2-selection select2-selection--single form-select form-select-sm bg-body border-body w-175px"
                                        role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                        aria-disabled="false" aria-labelledby="select2-campaign-type-sh-container"
                                        aria-controls="select2-campaign-type-sh-container"><span
                                            class="select2-selection__rendered" id="select2-campaign-type-sh-container"
                            ...
                            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10"
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <!--begin::Subtitle-->
                                        <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Active Projects in
                                            April</span>
                                        <!--end::Subtitle-->
                                    </div>
                                    <!--end::Title-->
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-toolbar d-none">
                                        ...
                                        <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left"
                                            ...
                                            data-kt-initialized="1">
                                            <!--begin::Display range-->
                                            <div class="text-gray-600 fw-bold">12 Nov 2024 - 11 Dec 2024</div>
                                            <!--end::Display range-->
                                        ...
                                        <ul class="nav" id="kt_chart_widget_8_tabs" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1"
                                                    ...
                                                    href="#kt_chart_widget_8_week_tab" aria-selected="false"
                                                    tabindex="-1" role="tab">Month</a>
                                            </li>
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 active"
                                                    ...
                                                    href="#kt_chart_widget_8_month_tab" aria-selected="true"
                                                    role="tab">Week</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card-body pt-6">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade active show" id="kt_chart_widget_8_month_tab"
                                            role="tabpanel" aria-labelledby="kt_chart_widget_8_month_toggle">
                                            <!--begin::Statistics-->
                                            <div class="mb-5">
                                                <!--begin::Statistics-->
                                                <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left"
                                            ...
                                            data-kt-initialized="1">
                                            <!--begin::Display range-->
                                            <div class="text-gray-600 fw-bold">11 Dec 2024</div>
                                            <!--end::Display range-->
                                ...
                                <div class="card-body py-0 px-0">
                                    ...
                                    <ul class="nav d-flex justify-content-between mb-3 mx-9" role="tablist">
                                        ...
                                        <li class="nav-item mb-3" role="presentation">
                                            ...
                                            <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px active"
                                                ...
                                                href="#kt_charts_widget_35_tab_content_1" aria-selected="true"
                                                role="tab">
                                        ...
                                        <li class="nav-item mb-3" role="presentation">
                                            ...
                                            <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px "
                                                ...
                                                href="#kt_charts_widget_35_tab_content_2" aria-selected="false"
                                                tabindex="-1" role="tab">
                                        ...
                                        <li class="nav-item mb-3" role="presentation">
                                            ...
                                            <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px "
                                                ...
                                                href="#kt_charts_widget_35_tab_content_3" aria-selected="false"
                                                tabindex="-1" role="tab">
                                        ...
                                        <li class="nav-item mb-3" role="presentation">
                                            ...
                                            <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px "
                                                ...
                                                href="#kt_charts_widget_35_tab_content_4" aria-selected="false"
                                                tabindex="-1" role="tab">
                                        ...
                                        <li class="nav-item mb-3" role="presentation">
                                            ...
                                            <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px "
                                                ...
                                                href="#kt_charts_widget_35_tab_content_5" aria-selected="false"
                                                tabindex="-1" role="tab">
                                    ...
                                    <div class="tab-content mt-n6">
                                        ...
                                        <div class="tab-pane fade active show" id="kt_charts_widget_35_tab_content_1"
                                            role="tabpanel" aria-labelledby="kt_charts_widget_35_tab_1">
                                            <!--begin::Chart-->
                                        ...
                                        <div class="tab-pane fade " id="kt_charts_widget_35_tab_content_2"
                                            role="tabpanel" aria-labelledby="kt_charts_widget_35_tab_2">
                                            <!--begin::Chart-->
                                        ...
                                        <div class="tab-pane fade " id="kt_charts_widget_35_tab_content_3"
                                            role="tabpanel" aria-labelledby="kt_charts_widget_35_tab_3">
                                            <!--begin::Chart-->
                                        ...
                                        <div class="tab-pane fade " id="kt_charts_widget_35_tab_content_4"
                                            role="tabpanel" aria-labelledby="kt_charts_widget_35_tab_4">
                                            <!--begin::Chart-->
                                        ...
                                        <div class="tab-pane fade " id="kt_charts_widget_35_tab_content_5"
                                            role="tabpanel" aria-labelledby="kt_charts_widget_35_tab_5">
                                            <!--begin::Chart-->
