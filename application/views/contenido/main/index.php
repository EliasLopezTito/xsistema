...
<div class="d-flex align-items-center gap-2 gap-lg-3">
            <!--begin::Filter menu-->
        <div class="d-flex">
            <select name="campaign-type" data-control="select2" data-hide-search="true" class="form-select form-select-sm bg-body border-body w-175px select2-hidden-accessible" data-select2-id="select2-data-7-6vgv" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                <option value="Twitter" selected="selected" data-select2-id="select2-data-9-i40c">Select Campaign</option>
                <option value="Twitter">Twitter Campaign</option>
                <option value="Twitter">Facebook Campaign</option>
                <option value="Twitter">Adword Campaign</option>
                <option value="Twitter">Carbon Campaign</option>
            </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-8-r3c2" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-sm bg-body border-body w-175px" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-campaign-type-sh-container" aria-controls="select2-campaign-type-sh-container"><span class="select2-selection__rendered" id="select2-campaign-type-sh-container" role="textbox" aria-readonly="true" title="Select Campaign">Select Campaign</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
